...
to a cloze type first, via Edit>Change Note Type."""))
    ...
    def onAdvanced(self):
        menu = QMenu(self.mw)
        action = menu.addAction(_("MathJax inline"))
        action.triggered.connect(self.insertMathjaxInline)
        action.setShortcut(QKeySequence("Ctrl+MENU, MENU"))
        action = menu.addAction(_("MathJax block"))
        action.triggered.connect(self.insertMathjaxBlock)
        action.setShortcut(QKeySequence("Ctrl+MENU, E"))
        action = menu.addAction(_("MathJax chemistry"))
        action.triggered.connect(self.insertMathjaxChemistry)
        action.setShortcut(QKeySequence("Ctrl+MENU, C"))
        action = menu.addAction(_("LaTeX"))
        action.triggered.connect(self.insertLatex)
        action.setShortcut(QKeySequence("Ctrl+T, T"))
        action = menu.addAction(_("LaTeX equation"))
        action.triggered.connect(self.insertLatexEqn)
        action.setShortcut(QKeySequence("Ctrl+T, E"))
        action = menu.addAction(_("LaTeX math env."))
        action.triggered.connect(self.insertLatexMathEnv)
        action.setShortcut(QKeySequence("Ctrl+T, MENU"))
        action = menu.addAction(_("Edit HTML"))
        action.triggered.connect(self.onHtmlEdit)
...
class EditorWebView(AnkiWebView):
    ...
    def contextMenuEvent(self, evt):
        ...
        action.triggered.connect(self.onCut)
        action = menu.addAction(_("Copy"))
        action.triggered.connect(self.onCopy)
        action = menu.addAction(_("Paste"))
        action.triggered.connect(self.onPaste)
